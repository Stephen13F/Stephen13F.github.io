...
If you just used them for solvent, just rinse them out and dry them off with acetone (rinse out chlorinated waste with alcohol first). If you used some sort of aqueous solution (e.g. NaOH) then I would advise rinsing with water first (ensure water is neutralised before disposal and don't throw toxic salts down the sink) then acetone. You probably do not need to scrub with a brush though. If you used to to measure a solution of something containing an organic compound, I would probably give it a proper full wash.
